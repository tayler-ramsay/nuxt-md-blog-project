<template>
  <div>
    <div
      class="bg-white flex flex-col lg:flex-row justify-evenly px-10 items-center pt-32 lg:pb-32"
    >
      <div class="max-w-6xl">
        <div class="flex">
        ...
        <h1
          class="text-2xl lg:text-4xl font-semibold text-blue-light max-w-6xl leading-8 lg:leading-10 mb-10"
        >
    ...
    <div class="grad pt-20">
      <div
        class="flex  flex-col lg:flex-row flex-wrap max-w-5xl mx-auto px-20 lg:px-0"
      >
        <div class="font-semibold text-white text-2xl lg:min-w-1/2 ">
        ...
        <div class="font-semibold text-white text-2xl lg:min-w-1/2 lg:pl-20">
